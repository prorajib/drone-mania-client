        ...
        <Row>
          ...
          <Col xs={12} md={6}>
            <div className='drone-info'>
              <h1>Specializing in Drone Services, and Aerial Photography</h1>
              <p>
                Drones are more formally known as unmanned aerial vehicles
                (UAVs) or unmanned aircraft systems (UASes). Essentially, a
                drone is a flying robot that can be remotely controlled or fly
