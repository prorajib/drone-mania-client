...
const ManageAllOrder = () => {
  ...
  useEffect(() => {
    fetch('https://drone-mania-server.onrender.com/orders')
      .then((res) => res.json())
      .then((data) => {
        setManageOrder(data);
        setLoad(false);
  ...
  const handleDelete = (id) => {
    ...
    if (proceed) {
      fetch(`https://drone-mania-server.onrender.com/orders/${id}`, {
        method: 'DELETE',
      })
        .then((res) => res.json())
        .then((data) => {
  ...
  const handleUpdate = (id) => {
    ...
    const uri = `https://drone-mania-server.onrender.com/orders/${id}`;
    fetch(uri, {
      method: 'PUT',
      headers: {
